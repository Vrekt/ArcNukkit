...
public abstract class ConfigurableReader {
     ...
     * @return the string
     */
    protected String getString(ConfigSection configuration, ConfigurationValues value) {
     ...
     * @return the int
     */
    protected int getInteger(ConfigSection configuration, ConfigurationValues value) {
     ...
     * @return the boolean
     */
    protected boolean getBoolean(ConfigSection configuration, ConfigurationValues value) {
     ...
     * @return the string
     */
    protected String getString(Config configuration, ConfigurationValues value) {
        final String str = configuration.getString(value.valueName(), value.stringValue());
        if (!configuration.exists(value.valueName())) {
            configuration.set(value.valueName(), value.stringValue());
        }
     ...
     * @return the int
     */
    protected int getInteger(Config configuration, ConfigurationValues value) {
        final int number = configuration.getInt(value.valueName(), value.intValue());
        if (!configuration.exists(value.valueName())) {
            configuration.set(value.valueName(), value.intValue());
        }
     ...
     * @return the boolean
     */
    protected boolean getBoolean(Config configuration, ConfigurationValues value) {
        final boolean b = configuration.getBoolean(value.valueName(), value.booleanValue());
        if (!configuration.exists(value.valueName())) {
            configuration.set(value.valueName(), value.booleanValue());
        }
     ...
     */
    protected BanListType getBanListType(Config configuration, ConfigurationValues value) {
     ...
     */
    protected BanLengthType getBanLengthType(Config configuration, ConfigurationValues value) {
        final String raw = configuration.getString(value.valueName());
        if (raw == null) {
